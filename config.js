...
global.caption = process.env.CAPTION || global.caption || "Thé bot of gee²²¹-ᴍᴅ" 
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 thé bot of gee ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "Stacha___Boy",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "Thé bot of gee",
